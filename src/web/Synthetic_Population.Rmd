...
<<<<<<< HEAD
- Final step of IPF involves attaching **lat/longs** to the synthetic population. 
...
```
=======
- Final step of IPF involves attaching **lat/longs** to the synthetic population. For that process we took the blackknight housing data and took out the latitiudes and longitudents and performed shape file conversion and linked it to our IPF outputs.
>>>>>>> b670ed21c8a6a801419e319877ea09a9cdbf1b6c
