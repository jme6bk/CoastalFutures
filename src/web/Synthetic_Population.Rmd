...
![](www/IPFoutput.png)</center>

- There is a **Resampling process** invloved with microdata which is just simple **random sample** with replacement
...
![](www/LATLON.png)</center>

-There are three methods to increase the sophistication. 
  + a)Choose a lat/long sampled uniformly over the Block Group
  + b) Sample from actual housing units
  + c) Match people to housing units
